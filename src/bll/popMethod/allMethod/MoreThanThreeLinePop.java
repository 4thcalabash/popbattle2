...
//			System.out.println();
//		}
		if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()!=Matrix.NORMAL&&chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()!=Matrix.NORMAL){
			return true;
		}
		if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()==Matrix.CHICKBONUS||chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.CHICKBONUS){
			return true;
		}
		for (int i = 0; i < Matrix.TOTALLINE; i++) {
			for (int j = 0; j < Matrix.TOTALROW; j++) {
	...
	public void pop(Matrix chessboard, DotPo dot1, DotPo dot2) {
		...
		if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()==Matrix.CHICKBONUS&&chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.CHICKBONUS){
		...
		}else if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()==Matrix.CHICKBONUS||chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.CHICKBONUS){
			...
			if (chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.NORMAL){
				...
				for (int i=0;i<Matrix.TOTALLINE;i++){
					for (int j=0;j<Matrix.TOTALROW;j++){
						if (chessboard.getMatrix()[i][j].getColor()==chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor()){
							dead[i][j]=true;
						}
					}
				}
				...
				//queue.add(new DotPo (dot1.getX(),dot1.getY(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor()*1000+Matrix.NORMAL,Matrix.CHICKBONUS));
				...
				for (int i=0;i<Matrix.TOTALLINE;i++){
					for (int j=0;j<Matrix.TOTALROW;j++){
						if (chessboard.getMatrix()[i][j].getColor()==chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor()){
								chessboard.getMatrix()[i][j].setBonus((bonus==Matrix.BOMBBONUS)?Matrix.BOMBBONUS:(Math.random()>0.5?Matrix.LINEBONUS:Matrix.ROWBONUS));
							System.out.println("("+i+","+j+")->"+chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus());
							dead[i][j]=true;
						}
					}
				}
		...
		}else if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()!=Matrix.NORMAL&&chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()!=Matrix.NORMAL){
			...
			if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()!=Matrix.BOMBBONUS){
				...
				queue.add(new DotPo (dot1.getX(),dot1.getY(),chessboard.getMatrix()[dot1.getX()][dot1.getY()].getColor(),chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()));
				queue.add(new DotPo (dot2.getX(),dot2.getY(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()));
				chessboard.getIsPop()[dot1.getX()][dot1.getY()]=chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus();
				chessboard.getIsPop()[dot2.getX()][dot2.getY()]=chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus();
				...
				for (int i =dot1.getX()-3;i<=dot1.getX()+3;i++){
					for (int j=dot1.getY()-3;j<=dot1.getY()+3;j++){
			...
			for (int i = 0; i < Matrix.TOTALLINE; i++) {
				for (int j = 0; j < Matrix.TOTALROW; j++) {
					...
					// 上
					int dx=1,dy=0;
					while (tempx + dx < Matrix.TOTALLINE &&tempy+dy<Matrix.TOTALROW&& chessboard.getMatrix()[tempx + dx][tempy+dy].getColor() == color) {
						tempx+=dx;
						tempy+=dy;
					}
					if (tempx+tempy-i-j>=4){
						...
						if (dot1.getX()>=i&&dot1.getX()<=tempx&&dot1.getY()>=j&&dot1.getY()<=tempy){
							...
							if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()==Matrix.NORMAL){
								...
								chessboard.getIsPop()[dot1.getX()][dot1.getY()]=chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus();
								queue.add(new DotPo (dot1.getX(),dot1.getY(),chessboard.getMatrix()[dot1.getX()][dot1.getY()].getColor(),chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()));
								queue.add(new DotPo (dot1.getX(),dot1.getY(),chessboard.getMatrix()[dot1.getX()][dot1.getY()].getColor(),Matrix.CHICKBONUS));
								in[dot1.getX()][dot1.getY()]=1234;
							...
							if (chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.NORMAL){
								...
								chessboard.getIsPop()[dot2.getX()][dot2.getY()]=chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus();
								queue.add(new DotPo (dot2.getX(),dot2.getY(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()));
								queue.add(new DotPo (dot2.getX(),dot2.getY(),chessboard.getMatrix()[dot2.getX()][dot2.getY()].getColor(),Matrix.CHICKBONUS));
								in[dot2.getX()][dot2.getY()]=1234;
						...
						if (tempx+tempy-i-j==3){
							...
							if (dot1.getX()>=i&&dot1.getX()<=tempx&&dot1.getY()>=j&&dot1.getY()<=tempy){
								...
								if (chessboard.getMatrix()[dot1.getX()][dot1.getY()].getBonus()==Matrix.NORMAL){
									...
									chessboard.getIsPop()[dot1.getX()][dot1.getY()]=temp<=0.5?Matrix.TOLINEBONUS:Matrix.TOROWBONUS;
									chessboard.getMatrix()[dot1.getX()][dot1.getY()].setBonus(chessboard.getIsPop()[dot1.getX()][dot1.getY()]/10);
									//in[dot1.getX()][dot1.getY()]=1234;
									dead[dot1.getX()][dot1.getY()]=false;
								}else{
									//dot1 直接入队
								...
								if (chessboard.getMatrix()[dot2.getX()][dot2.getY()].getBonus()==Matrix.NORMAL){
									//dot1变特效 不入队
									double temp = Math.random();
									chessboard.getIsPop()[dot2.getX()][dot2.getY()]=temp<=0.5?Matrix.TOLINEBONUS:Matrix.TOROWBONUS;
									chessboard.getMatrix()[dot2.getX()][dot2.getY()].setBonus(chessboard.getIsPop()[dot2.getX()][dot2.getY()]/10);
									//in[dot1.getX()][dot1.getY()]=1234;
									dead[dot2.getX()][dot2.getY()]=false;
								}else{
									//dot1 直接入队
								...
								for (int ii=i;ii<=tempx;ii++){
									for (int jj=j;jj<=tempy;jj++){
										if (chessboard.getMatrix()[ii][jj].getBonus()==Matrix.NORMAL){
											chessboard.getIsPop()[ii][jj]=Math.random()>=0.5?Matrix.TOLINEBONUS:Matrix.TOROWBONUS;
		...
		for (int i=0;i<Matrix.TOTALLINE;i++){
			for (int j=0;j<Matrix.TOTALROW;j++){
				if (linecheck[i][j]==1&&rowcheck[i][j]==1&&chessboard.getMatrix()[i][j].getBonus()==Matrix.NORMAL){
					//爆炸特效 不入队
		...
		for (int i=0;i<Matrix.TOTALLINE;i++){
			for (int j=0;j<Matrix.TOTALROW;j++){
				...
				if (dead[i][j]&&(in[i][j]!=1234)){
					in[i][j]=1234;
					queue.add(new DotPo (i,j,chessboard.getMatrix()[i][j].getColor(),chessboard.getMatrix()[i][j].getBonus()));
				}
			}
		}
//		
			...
			if (head.getBonus()==Matrix.NORMAL){
				...
				for (int j=0;j<Matrix.TOTALROW;j++){
					if (!dead[head.getX()][j]){
						...
						queue.add(new DotPo(head.getX(),j,chessboard.getMatrix()[head.getX()][j].getColor(),chessboard.getMatrix()[head.getX()][j].getBonus()));
					}
				}
				...
				for (int i=0;i<Matrix.TOTALLINE;i++){
					if (!dead[i][head.getY()]){
						...
						queue.add(new DotPo(i,head.getY(),chessboard.getMatrix()[i][head.getY()].getColor(),chessboard.getMatrix()[i][head.getY()].getBonus()));
					}
				}
			...
			for (int i=0;i<Matrix.TOTALLINE;i++){
				for (int j=0;j<Matrix.TOTALROW;j++){
					...
					if (rowcheck[i][j]!=1){
						...
						//System.out.println("Start At "+"("+i+","+j+")"+"End At "+"("+tempx+","+tempy+")");
						if (tempx+tempy-i-j==3){
							for (int ii=i;ii<=tempx;ii++){
								for (int jj=j;jj<=tempy;jj++){
									rowcheck[ii][jj]=1;
					...
					if (j+2<Matrix.TOTALROW){
						if (chessboard.getMatrix()[i][j+1].getColor()==color){
							if (i-1>=0&&chessboard.getMatrix()[i-1][j+2].getColor()==color){
								return true;
							}else if (i+1<Matrix.TOTALLINE&&chessboard.getMatrix()[i+1][j+2].getColor()==color){
								return true;
							}
						}
						if (chessboard.getMatrix()[i][j+2].getColor()==color){
							if (i-1>=0&&chessboard.getMatrix()[i-1][j+1].getColor()==color){
								return true;
							}else if (i+1<Matrix.TOTALLINE&&chessboard.getMatrix()[i+1][j+1].getColor()==color){
								return true;
							}
						}
					}
					if (i+2<Matrix.TOTALLINE){
						if (chessboard.getMatrix()[i+1][j].getColor()==color){
							if (j-1>=0&&chessboard.getMatrix()[i+2][j-1].getColor()==color){
								return true;
							}else if (j+1<Matrix.TOTALROW&&chessboard.getMatrix()[i+2][j+1].getColor()==color) {
								return true;
							}
						}
						if (chessboard.getMatrix()[i+2][j].getColor()==color){
							if (j-1>=0&&chessboard.getMatrix()[i+1][j-1].getColor()==color){
								return true;
							}else if (j+1<Matrix.TOTALROW&&chessboard.getMatrix()[i+1][j+1].getColor()==color){
								return true;
							}
						}
					}
