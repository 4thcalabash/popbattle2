...
public class PointBoard extends AnchorPane{
	...
	private void addLeftLabel(){
		...
		l0.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
		l0.setLayoutY(0);
		l1.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
		l1.setLayoutY(ICONLENGTH);
		l2.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
		l2.setLayoutY(ICONLENGTH*2);
		l3.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
		l3.setLayoutY(ICONLENGTH*3);
		l4.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
		l4.setLayoutY(ICONLENGTH*4);
		l5.setLayoutX(BOARDWIDTH/2-ICONLENGTH*2-ICONLENGTH*2);
